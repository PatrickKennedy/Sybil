...
var humanMsg = {
	...
	displayMsg: function(msg) {
		...
		jQuery('#'+humanMsg.msgID).attr('className', function() {
			return this.className; //+ ' ' + msg_type;
		});
		...
		// Watch for mouse & keyboard in 1.25s
		humanMsg.t1 = setTimeout(humanMsg.bindEvents, 1250);
	...
	// Remove message if mouse is moved or key is pressed
		jQuery(window)
			.bind('mousemove', humanMsg.removeMsg)
